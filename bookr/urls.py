...
urlpatterns = [
	...
	url(r'^artistdashboard/$', views.ArtistDashboard.as_view(), name='brr-dashboard'),
	url(r'^bookerdashboard/$', views.BookerDashboard.as_view(), name='brr-dashboard'),	url(r'^venue/$', views.VenueIndex.as_view(), name='brr-venueindex'),
	...
	url(r'^addevent/$', views.AddEventInfo.as_view(), name='bbr-addevent'),
